...
let project = "Feliz.UseListener"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "React hook for easy event listener management."

// Author(s) of the project
let author = "Cody Johnson"

// File system information
let solutionFile = "Feliz.UseListener.sln"

// Github repo
let repo = "https://github.com/Shmew/Feliz.UseListener"
...
Target.create "CopyDocFiles" <| fun _ ->
    [ pub @@ "UseListener/README.md", __SOURCE_DIRECTORY__ @@ "README.md"
      pub @@ "UseListener/RELEASE_NOTES.md", __SOURCE_DIRECTORY__ @@ "RELEASE_NOTES.md"
...
Target.create "PackageJson" <| fun _ ->
    let setValues (current: Json.JsonPackage) =
        { current with
            ...
            Bugs = 
                { Json.BugsValue.Url = 
                    @"https://github.com/Shmew/Feliz.UseListener/issues/new/choose" |> Some } |> Some
            License = "MIT" |> Some
            Author = author |> Some
            Private = true |> Some }
